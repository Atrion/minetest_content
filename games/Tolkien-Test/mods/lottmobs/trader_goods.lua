...
-- Added for Bombadil
-- He's got some valuable presents... if you can find him!
-- Oddly, Tom has no use for metals and ores.  He does like pipeweed!

lottmobs.bombadil = {
	items = {
		{"lottores:mithril_block 2", "lottfarming:pipeweed_cooked 20", 25},
		
		{"lottores:tilkal 2", "lottfarming:pipeweed_cooked 20", 25},
		{"lottores:galvorn_block 2", "lottfarming:pipeweed_cooked 20", 25},
		
		{"default:goldblock 4", "lottfarming:pipeweed_cooked 20", 25},
		{"lottores:silver_block 4", "lottfarming:pipeweed_cooked 20", 25},
		
		{"boats:sail_boat 1", "lottfarming:pipeweed_cooked 4", 25},
		
		{"lottpotion:beer 20", "lottfarming:pipeweed_cooked 8", 25},
		{"lottpotion:cider 20", "lottfarming:pipeweed_cooked 8", 25},
		{"lottpotion:wine 20", "lottfarming:pipeweed_cooked 8", 25},
	},
	items_race = {
		{"lottores:mithril_block 2", "lottfarming:pipeweed_cooked 20", 25},
	...
	messages = {
		"Old Tom Bombadil is a jolly fellow. Bright blue his jacket is, and his boots are yellow!",
	}
}
