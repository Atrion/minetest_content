...
mobs:register_mob("lottmobs:dwarf_guard", {
	...
	visual_size = {x=1.8, y=.85},
	
	collisionbox = {-0.4,-.95,-0.4, 0.4,0.68,0.4},
	textures = {
...
mobs:register_mob("lottmobs:elf_guard", {
	...
	hp_min = 25,
	hp_max = 25,
	collisionbox = {-0.3,-1.1,-0.3, 0.3,1,0.3},
...
-- More guardians for Black Ocarina, personal Spider and Nazgul!
