...
mobs:register_spawn("lottmobs:raiding_orc", {"default:stone"}, 2, -1, 20000, 3, -40)
...
-- Because orcs live underground, right?
-- Same spawn rate as nazgul
mobs:register_spawn("lottmobs:uruk_hai", {"default:stone"}, 2, -1, 20000, 3, -40)
...
mobs:register_spawn("lottmobs:witch_king", {"default:stone"}, 2, -1, 60000, 6, -1000) --40000 10
...
mobs:register_spawn("lottmobs:balrog", {"default:stone"}, 2, -1, 100000, 2, -3000)
...
mobs:register_spawn("lottmobs:dead_men", {"default:stone"}, 2, -1, 80000, 2, -100)
