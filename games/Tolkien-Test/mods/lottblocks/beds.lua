...
function bed_kick_players()
	for name, _ in pairs(lottblocks.player) do
		local player = minetest.get_player_by_name(name)
		lottblocks.lay_down(player, nil, nil, false)
	end
end
function is_night_skip_enabled()
...
function update_formspecs(finished)
...
function check_in_beds(players)
...
function bed_on_rightclick(pos, player)
	local name = player:get_player_name()
