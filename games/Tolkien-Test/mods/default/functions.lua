...
-- Added for Church mod, so it had metal sounds?
...
-- Beam damage has a chance to be done twice to a player/mob because the beam can be in range of a player in
-- two places along its path.  I fixed for healing beams, because that was OP, but it remains in Sting
