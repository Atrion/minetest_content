...
minetest.register_tool("lottarmor:helmet_galvorn", {
	...
	groups = {armor_head=15, armor_heal=12, armor_use=100, armor_healing=0, physics_speed=-0.04, forbidden=1},
	wear = 0,
})
...
minetest.register_tool("lottarmor:chestplate_galvorn", {
	...
	groups = {armor_torso=20, armor_heal=12, armor_use=100, armor_healing=0, physics_speed=-0.04, forbidden=1},
	wear = 0,
})
...
minetest.register_tool("lottarmor:leggings_galvorn", {
	...
	groups = {armor_legs=20, armor_heal=12, armor_use=100, armor_healing=0, physics_speed=-0.04, forbidden=1},
	wear = 0,
})
...
minetest.register_tool("lottarmor:boots_galvorn", {
	...
	groups = {armor_feet=15, armor_heal=12, armor_use=100, armor_healing=0, physics_speed=-0.04, forbidden=1},
	wear = 0,
})
