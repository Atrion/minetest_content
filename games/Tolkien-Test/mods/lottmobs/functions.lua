                ...
                if entity_type == "player" or entity_type == "npc" or entity_type == "monster" then
                        ...
                        if dist < self.view_range then
                                ...
                                and dist < min_dist then
                                        ...
                                        and self.whitelist and not value_in_table(self.whitelist, player:get_player_name()) then
                                                
                                                local player_privs = minetest.get_player_privs(player:get_player_name())
                                                
                                                
                                                if (self.attack_player_GAMEelf and player_privs.GAMEelf and not player_privs.GAMEwizard)
                                                or (self.attack_player_GAMEman and player_privs.GAMEman and not player_privs.GAMEwizard)
                                                or (self.attack_player_GAMEorc and player_privs.GAMEorc and not player_privs.GAMEwizard)
                                                or (self.attack_player_GAMEhobbit and player_privs.GAMEhobbit and not player_privs.GAMEwizard)
                                                or (self.attack_player_GAMEdwarf and player_privs.GAMEdwarf and not player_privs.GAMEwizard)
                                        ...
                                        -- Don't hit yourself!  Yes, this was a problem.
                                        
                                        and player:get_luaentity().name ~= self.object:get_luaentity().name
                                        
                                        --and npc_race ~= "ents" 
                                        --and self.race ~= npc_race
                                        ...
                                        elseif self.blacklist
                                        and entity_type == "player"
                                        and value_in_table(self.blacklist, player:get_player_name())
                                        then
                                        	
                                        	-- Added this so you can blacklist yourself :)
                                        	-- Because sometimes you want your guard to beat you up?
