...
minetest.register_craftitem("hyruletools:ocarina", {
	...
	on_use = function(pos, placer)
		...
		minetest.sound_play("hyruletools_tune", {gain = 0.5, max_hear_distance = 15, pos = sound_pos})
...
minetest.register_craftitem("hyruletools:ocarina2", {
	...
	on_use = function(pos, placer)
		local sound_pos = placer:get_pos()
		minetest.sound_play("hyruletools_epona", {gain = 0.5, max_hear_distance = 15, pos = sound_pos})
		local dir = placer:get_look_dir();
			local playerpos = placer:getpos();
			minetest.add_particlespawner(
			5, --amount
...
minetest.register_craftitem("hyruletools:ocarina3", {
	...
	on_use = function(pos, placer)
		local sound_pos = placer:get_pos()
		minetest.sound_play("hyruletools_trumpet", {gain = 0.5, max_hear_distance = 15, pos = sound_pos})
		local dir = placer:get_look_dir();
			local playerpos = placer:getpos();
			minetest.add_particlespawner(
			5, --amount
...
minetest.register_craftitem("hyruletools:ocarina4", {
	...
	on_use = function(pos, placer, itemstack)
		local sound_pos = placer:get_pos()
		minetest.sound_play("hyruletools_forest", {gain = 0.5, max_hear_distance = 15, pos = sound_pos})
		local dir = placer:get_look_dir();
			local playerpos = placer:getpos();
			minetest.add_particlespawner(
			5, --amount
		...
		if math.random(10) == 1 then
			local dir = placer:get_look_dir();
			local obj = minetest.env:add_entity({x=playerpos.x+1+dir.x,y=playerpos.y+1+dir.y,z=playerpos.z+1+dir.z}, "lottmobs:sheep")
		end
	end
})
