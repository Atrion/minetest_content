...
minetest.register_node("default:torch", {
	...
	drawtype = "nodebox",
	tiles = {
		{name = "default_torch_top.png",    animation = {type = "vertical_frames", aspect_w = 16, aspect_h = 16, length = 5.0}},
		{name = "default_torch_bottom.png", animation = {type = "vertical_frames", aspect_w = 16, aspect_h = 16, length = 5.0}},
		{name = "default_torch_side.png",   animation = {type = "vertical_frames", aspect_w = 16, aspect_h = 16, length = 5.0}},
	},
